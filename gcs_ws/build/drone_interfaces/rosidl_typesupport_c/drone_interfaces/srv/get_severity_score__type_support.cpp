...
static const _GetSeverityScore_Request_type_support_symbol_names_t _GetSeverityScore_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_interfaces, srv, GetSeverityScore_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, drone_interfaces, srv, GetSeverityScore_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, drone_interfaces, srv, GetSeverityScore_Request)() {
  return &::drone_interfaces::srv::rosidl_typesupport_c::GetSeverityScore_Request_message_type_support_handle;
}
...
static const _GetSeverityScore_Response_type_support_symbol_names_t _GetSeverityScore_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_interfaces, srv, GetSeverityScore_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, drone_interfaces, srv, GetSeverityScore_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, drone_interfaces, srv, GetSeverityScore_Response)() {
  return &::drone_interfaces::srv::rosidl_typesupport_c::GetSeverityScore_Response_message_type_support_handle;
}
...
static const _GetSeverityScore_type_support_symbol_names_t _GetSeverityScore_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_interfaces, srv, GetSeverityScore)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, drone_interfaces, srv, GetSeverityScore)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, drone_interfaces, srv, GetSeverityScore)() {
  return &::drone_interfaces::srv::rosidl_typesupport_c::GetSeverityScore_service_type_support_handle;
}
