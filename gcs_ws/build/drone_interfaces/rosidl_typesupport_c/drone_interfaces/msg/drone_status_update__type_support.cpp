...
static const _DroneStatusUpdate_type_support_symbol_names_t _DroneStatusUpdate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_interfaces, msg, DroneStatusUpdate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, drone_interfaces, msg, DroneStatusUpdate)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, drone_interfaces, msg, DroneStatusUpdate)() {
  return &::drone_interfaces::msg::rosidl_typesupport_c::DroneStatusUpdate_message_type_support_handle;
}
