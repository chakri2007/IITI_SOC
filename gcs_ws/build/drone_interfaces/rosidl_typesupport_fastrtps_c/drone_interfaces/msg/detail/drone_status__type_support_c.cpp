...
#include "drone_interfaces/msg/detail/drone_status__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // direction, drone_id, status, type
#include "rosidl_runtime_c/string_functions.h"  // direction, drone_id, status, type

// forward declare type support functions


using _DroneStatus__ros_msg_type = drone_interfaces__msg__DroneStatus;
...
size_t get_serialized_size_drone_interfaces__msg__DroneStatus(
  const void * untyped_ros_message,
...
static uint32_t _DroneStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drone_interfaces__msg__DroneStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drone_interfaces
size_t max_serialized_size_drone_interfaces__msg__DroneStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_interfaces__msg__DroneStatus;
    is_plain =
      (
...
static size_t _DroneStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drone_interfaces__msg__DroneStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_interfaces, msg, DroneStatus)() {
