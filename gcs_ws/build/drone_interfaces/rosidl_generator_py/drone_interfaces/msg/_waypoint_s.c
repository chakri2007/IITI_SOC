...
bool drone_interfaces__msg__waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("drone_interfaces.msg._waypoint.Waypoint", full_classname_dest, 39) == 0);
  }
  drone_interfaces__msg__Waypoint * ros_message = _ros_message;
  {  // id
  ...
  {  // visited
    ...
    ros_message->visited = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * drone_interfaces__msg__waypoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("drone_interfaces.msg._waypoint");
  ...
  {  // visited
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->visited ? 1 : 0);
    {
