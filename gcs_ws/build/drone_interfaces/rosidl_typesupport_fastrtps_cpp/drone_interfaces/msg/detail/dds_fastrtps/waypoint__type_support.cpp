...
#include "drone_interfaces/msg/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const drone_interfaces::msg::Waypoint & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.alt;
  // Member: visited
  cdr << (ros_message.visited ? true : false);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  drone_interfaces::msg::Waypoint & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  // Member: visited
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.visited = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_interfaces::msg::Waypoint;
    is_plain =
      (
      offsetof(DataType, visited) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const drone_interfaces::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<drone_interfaces::msg::Waypoint *>(
    untyped_ros_message);
...
{
  return &drone_interfaces::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drone_interfaces, msg, Waypoint)() {
  return &drone_interfaces::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
