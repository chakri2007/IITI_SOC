...
#include "drone_interfaces/srv/detail/get_severity_score__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_interfaces::srv::GetSeverityScore_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const drone_interfaces::srv::GetSeverityScore_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<drone_interfaces::srv::GetSeverityScore_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetSeverityScore_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const drone_interfaces::srv::GetSeverityScore_Request *>(
...
static size_t _GetSeverityScore_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetSeverityScore_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetSeverityScore_Request__callbacks = {
...
static rosidl_message_type_support_t _GetSeverityScore_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetSeverityScore_Request__callbacks,
...
{
  return &drone_interfaces::srv::typesupport_fastrtps_cpp::_GetSeverityScore_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = drone_interfaces::srv::GetSeverityScore_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const drone_interfaces::srv::GetSeverityScore_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<drone_interfaces::srv::GetSeverityScore_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetSeverityScore_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const drone_interfaces::srv::GetSeverityScore_Response *>(
...
static size_t _GetSeverityScore_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetSeverityScore_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetSeverityScore_Response__callbacks = {
  "drone_interfaces::srv",
...
static rosidl_message_type_support_t _GetSeverityScore_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetSeverityScore_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &drone_interfaces::srv::typesupport_fastrtps_cpp::_GetSeverityScore_Response__handle;
}
...
static service_type_support_callbacks_t _GetSeverityScore__callbacks = {
  "drone_interfaces::srv",
  "GetSeverityScore",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drone_interfaces, srv, GetSeverityScore_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drone_interfaces, srv, GetSeverityScore_Response)(),
...
static rosidl_service_type_support_t _GetSeverityScore__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetSeverityScore__callbacks,
...
{
  return &drone_interfaces::srv::typesupport_fastrtps_cpp::_GetSeverityScore__handle;
}
