...
bool drone_interfaces__msg__drone_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("drone_interfaces.msg._drone_status.DroneStatus", full_classname_dest, 46) == 0);
  }
  drone_interfaces__msg__DroneStatus * ros_message = _ros_message;
  {  // drone_id
...
PyObject * drone_interfaces__msg__drone_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("drone_interfaces.msg._drone_status");
