...
class Metaclass_WaypointVisited(type):
    """Metaclass of message 'WaypointVisited'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'drone_interfaces.msg.WaypointVisited')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__waypoint_visited
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__waypoint_visited
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__waypoint_visited
            cls._TYPE_SUPPORT = module.type_support_msg__msg__waypoint_visited
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__waypoint_visited
...
class WaypointVisited(metaclass=Metaclass_WaypointVisited):
    """Message class 'WaypointVisited'."""
