...
// Zurich Irchel Park
static constexpr const double kDefaultHomeLatitude = 22.524055 * M_PI / 180.0;   // rad
static constexpr const double kDefaultHomeLongitude = 75.921694 * M_PI / 180.0;   // rad
static constexpr const double kDefaultHomeAltitude = 553.0;                      // meters
