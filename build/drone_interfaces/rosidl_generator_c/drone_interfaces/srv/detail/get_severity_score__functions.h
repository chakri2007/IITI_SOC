...
#ifndef DRONE_INTERFACES__SRV__DETAIL__GET_SEVERITY_SCORE__FUNCTIONS_H_
#define DRONE_INTERFACES__SRV__DETAIL__GET_SEVERITY_SCORE__FUNCTIONS_H_
...
/// Initialize srv/GetSeverityScore message.
/**
...
/// Finalize srv/GetSeverityScore message.
/**
...
/// Create srv/GetSeverityScore message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * drone_interfaces__srv__GetSeverityScore_Request__init().
...
/// Destroy srv/GetSeverityScore message.
/**
 * It calls
 * drone_interfaces__srv__GetSeverityScore_Request__fini()
...
/// Check for srv/GetSeverityScore message equality.
/**
...
/// Copy a srv/GetSeverityScore message.
/**
...
/// Initialize array of srv/GetSeverityScore messages.
/**
...
/// Finalize array of srv/GetSeverityScore messages.
/**
 * It calls
 * drone_interfaces__srv__GetSeverityScore_Request__fini()
...
/// Create array of srv/GetSeverityScore messages.
/**
 * It allocates the memory for the array and calls
 * drone_interfaces__srv__GetSeverityScore_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetSeverityScore messages.
/**
 * It calls
 * drone_interfaces__srv__GetSeverityScore_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetSeverityScore message array equality.
/**
...
/// Copy an array of srv/GetSeverityScore messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * drone_interfaces__srv__GetSeverityScore_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_drone_interfaces
...
/**
 * It calls
 * drone_interfaces__srv__GetSeverityScore_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_drone_interfaces
...
/**
 * It allocates the memory for the array and calls
 * drone_interfaces__srv__GetSeverityScore_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_drone_interfaces
...
/**
 * It calls
 * drone_interfaces__srv__GetSeverityScore_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DRONE_INTERFACES__SRV__DETAIL__GET_SEVERITY_SCORE__FUNCTIONS_H_
